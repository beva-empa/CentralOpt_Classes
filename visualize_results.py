...
def model_visualize(own_results_path, i, df_elec_demand, df_elec_prod, df_thermal_demand, df_thermal_prod, df_storage, df_storage_SOC, df_Grid, df_CHP2_operation, df_CHP2, df_network_exp, df_network_imp):
